...
const Auth: React.FC<AuthProps> = ({ onLoginSuccess }) => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    setError('');
    // Mock registration and login success
    onLoginSuccess();
  };

  return (
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center font-sans text-gray-100 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-3 mb-2">
                ...
                <h1 className="text-4xl font-bold text-white">CodeGennie</h1>
            </div>
            <p className="text-gray-400">Your AI-powered code assistant.</p>
        </div>
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-2xl border border-gray-700">
          ...
          {isLoginView ? (
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                <label htmlFor="login-username" className="block text-sm font-medium text-gray-300 mb-1">Username or Email</label>
                <input
                  id="login-username"
                  type="text"
                  value={username}
          ...
          <div className="mt-6 text-center">
            <button onClick={() => { setIsLoginView(!isLoginView); setError(''); }} className="text-sm text-blue-400 hover:underline">
